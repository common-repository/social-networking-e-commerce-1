...
{
  class socialCheckoutWidget extends WP_Widget {
    /** constructor */
    function socialCheckoutWidget() {
        parent::WP_Widget(false, $name = __('Shopping Cart', 'social'));	
    }
    ...
    function widget($args, $instance) {
      ...
      ?>
        ...
        <?php require( social_VIEWS_PATH . '/social-store/checkout_widget.php' ); ?>
