...
Donate link: http://blairwilliams.com/social-donate
Tags: social, social network, network, networking, facebook, facebook wall, linkedin, twitter, social, wpsocial, wp-social, wpsocial.com, blair, blair williams, blairwilliams.com, pretty link, prettylink, pretty-link, buddypress, buddy-press, buddy press, widget, admin, page, pages, post, posts, posting, plugin, sidebar, comment, comments, commenting, images, social, friends, friend, avatar, avatars, gravatar, directory, users, user, profile, profiles, activity, activities, email, notification, notify, privacy, member, membership site, members, membership sites, community, communities, messaging, messages, message, ajax, javascript, login, logout, signup, signin, register, lost password, google, links, link, linking, twitter, international, internationalized, i18n, albanian, armenian, bulgarian, dutch, english, french, german, italian, persian, polish, romanian, russian, spanish, swedish, turkish, microblog, microblogging, premium, membership
...
= See social In Action! =
You can now try social out in our social Community! Come be my friend at:

[social WordPress Community](http://wpsocial.com "social WordPress Community")

= Note = 
social still hasn't been tested with every theme or browser in existence yet. However, social was developed and works exceptionally well on the [Thesis WordPress Theme](http://blairwilliams.com/thesis "Thesis WordPress Theme") (aff link) -- which is the best theme out there anyway in my humble opinion.

Want to setup a Premium Membership Website with a built in Social Network? Now you can roll one out easily by using social together with [Wishlist Member](http://blairwilliams.com/wishlistmember "Wishlist Member") (aff link). I've setup many premium memebership sites using several different software packages and like wishlist the best for its easy setup and its innovative features.
...
social is currently available in the following languages thanks to awesome translators!
...
If you don't see your language on this list or the translation in your language isn't adequate, please contact me on my blog at http://blairwilliams.com or at http://wpsocial.com and I can give you instructions on how to translate social.
...
3. Create a page for "Activity", "Profile", "Profile Settings", "Friends", "Friend Requests" and "Directory" -- and then configure social to use them in the social menu.
...
[social FAQ](http://blairwilliams.com/social "social FAQ")

== Changelog ==

= 0.0.32 =
* Added an admin option to disable the "Powered by social" links
* Added Private Messaging feature to social
...
* Fixed the "Some Admins can't get into the admin" bug when "Prevent Subscriber Admin Access" has been checked in social
...
* Added a registration spam email protection option in social's admin
...
* Fixes to the avatar system ... classes should line up for social pages and not be present for other code calling WordPress' get_avatar() method
* Optimized user dropdown calls in admin
* Updated Spanish, Bulgarian, Dutch, & Turkish
* Added invisible users feature -- you can select users that will be invisible in the social System
...
* Fixed the user dropdown performance issue in the social admin area
...
* Integrated social with wordpress comments (avatar override and profile link override for registered users)
* Fixed avatar upload & display issues and fixed numerous other bugs.

= 0.0.10 =
* Fixed CSS
* Added Profile Edit Link onto profile page
* Marked strings for translation throughout social
...
* Created a template tag for loading the user grid: social_display_user_grid($cols='3', $rows='2', $type='random')
* Created a template tag for loading the login / nav: social_display_login_nav()
...
= 0.0.31 =
If social has been conflicting with other javascript on your site, this fix could help.
...
= 0.0.27 =
Users who have been having issues sending mail should upgrade to this release to have more options... Developers creating social plugins should also upgrade for enhancements to the api.
...
== Screenshots ==
[social Screenshots](http://blairwilliams.com/social "social Screenshots")
