<?php
class socialNotificationApi
{
  /** Before your plugin can send a social notification, it must register itself as a source by using the social-notification-types
    * filter to add a code (the key of your array entry), name and icon url. Here's an example from the socialBoardsController class:
    *
  ...
  {
    socialNotification::send_notification_email_by_screenname($screenname, $subject, $message, $message_type);
  }
}
?>
