        ...
        socialFriend::can_friend($current_user->display_name, $_GET['u']))
    {
      ...
      if($current_user->display_name == $_GET['u'] || $_GET['u']=='')
      {
	   ...
	   <div id="sidemenu">
		...
		<li><img src="<?php echo social_IMAGES_URL; ?>/arrow.png" /><a href="<?php echo get_permalink($social_options->checkout_page_id); ?>"><?php _e('Checkout', 'social'); ?></a></li>
		  <li><img src="<?php echo social_IMAGES_URL; ?>/arrow.png" /><a href="<?php echo get_permalink($social_options->purchase_history_page_id); ?>"><?php _e('Purchse History', 'social'); ?></a></li>
            ...
            <div id="side-friend-grid"><div id="side-friend-grid1">Friends</div></div><?php echo $social_friends_controller->display_friends_grid($user->id); ?>
</div>
</div>