...
{
  class socialCategoryWidget extends WP_Widget {
    /** constructor */
    function socialCategoryWidget() {
        parent::WP_Widget(false, $name = __('Category Widget', 'social'));	
    }
    ...
    function widget($args, $instance) {
      ...
      ?>
        ...
        <?php require( social_VIEWS_PATH . '/social-store/category_widget.php' ); ?>
